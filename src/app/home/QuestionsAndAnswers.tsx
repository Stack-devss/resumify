...
const QAS = [
    ...
    answer: (
      <>
        ...
        <p>
          ...
          Resumify saves time and prevents formatting mistakes by
  ...
  {
    question:
      "Q2. What uniquely sets Resumify apart from other resume builders and templates?",
    answer: (
      <>
        <p>
          Other than Resumify, there are some great free resume builders out
          there, e.g. <Link href="https://rxresu.me/">Reactive Resume</Link>,{" "}
          <Link href="https://flowcv.com/">FlowCV</Link>. However, Resumify
          stands out with 2 distinctive features:
        </p>{" "}
        <p>
          <span className="font-semibold">
            1. Resumify is designed specifically for the U.S. job market and
            best practices.
          </span>
          <br />
          Unlike other resume builders that target a global audience and offer
          many customization options, Resumify intentionally only offers
  ...
  {
    question: "Q3. Who created Resumify and why?",
    answer: (
      <p>
        Resumify was created by{" "}
        <Link href="https://github.com/stack-devss">Xitang Zhao</Link> and designed
        ...
        that led to Resumify, where we integrated best practices and our
        knowledge into this resume builder. Our hope is that Resumify can help
  ...
  {
    question: "Q4. How can I support Resumify?",
    answer: (
      <>
        <p>
          The best way to support Resumify is to share your thoughts and
          feedback with us to help further improve it. You can send us an email
          at{" "}
          <Link href="mailto:hello@resumify.store">hello@resumify.store</Link>{" "}
          or{" "}
          <Link href="https://github.com/stack-devss/resumify/issues/new">
            open an issue
          </Link>{" "}
        ...
        <p>
          Another great way to support Resumify is by spreading the words.
